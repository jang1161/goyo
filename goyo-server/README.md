...
- **v3.5.0** (2025-01-20): Backend 오디오 캡처 및 Redis Pub/Sub 구현
- **v3.0.0** (2025-01-19): AI Server 분리, 기본 ANC 구현
- **v2.0.0** (2025-01-18): 디바이스 관리 및 프로필 API
- **v1.0.0** (2025-01-17): 인증 API 구현
